...
namespace IB.Api.Client.Examples
{
    public static class DataDownload
    {
        ...
        public static void RunBasicDownload(ConnectionDetails connectionDetails)
        {
            ...
            ibClient.ReqHistoricalData(1005, Contract, 1, DurationType.D, 5, BarSizeType.mins, WhatToShow.MIDPOINT, Rth.No, false);
        }
        public static void RunDownloadWithUpdates(ConnectionDetails connectionDetails)
        {
            ...
            ibClient.ReqHistoricalData(1005, Contract, 1, DurationType.D, 5, BarSizeType.mins, WhatToShow.MIDPOINT, Rth.No, true);
        }       
